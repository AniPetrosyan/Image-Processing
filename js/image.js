...
Pixel.prototype.rgbToXyz = function() {
  ...
  let x = 0.4124*p.data[0]+0.3576*p.data[1]+0.1805*p.data[2],
...
Pixel.prototype.xyzToLms = function() {
  ...
  let l = 0.40024*x + 0.7076*y - 0.08081*z,
...
Image.prototype.createImg = function( width, height ) {
  let data = this.createData( width, height );
...
Image.prototype.copyImg = function() {
  let data = this.createData( this.width, this.height );
